...
namespace Kaleidoscope
{
    ...
    /// child scope.</para>
    /// </remarks>
    internal sealed class ScopeStack<T>
    {
        ...
        public ScopeStack( )
        {
            this._scopes.Push( new Dictionary<string, T>( ) );
        }
        ...
        {
            this._scopes.Push( new Dictionary<string, T>( ) );
            return new DisposableAction( ( ) => this._scopes.Pop( ) );
        }
        ...
        {
            get => this.TryGetValue( name, out var retVal ) ? retVal : throw new KeyNotFoundException( name );
            set => this._scopes.Peek( )[ name ] = value;
        }
        ...
        private readonly Stack<IDictionary<string, T>> _scopes = new Stack<IDictionary<string, T>>();
    }
}